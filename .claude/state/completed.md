...
- [x] VP-8 — 2026-03-11 — Guest Web Flow (Next.js 14, 3-step wizard, QR credential, mobile-first, i18n, 34 tests)
- [x] VP-9 — 2026-03-11 — Onboarding & KYC (eKYC service, MyDigital ID OAuth 2.0 PKCE, DID binding, 19 tests)
